...
@@ -768,6 +787,86 @@ class OmniAgent(Agent):
...
+
     def _rescue_retrieval_slice(self, session: "OmniSession") -> Optional[RetrievalSlice]:
         if not self.config.autoterm_enable_open_rescue:
             return None
@@ -1100,6 +1199,9 @@ class OmniAgent(Agent):
...
@@ -1411,9 +1513,14 @@ class OmniAgent(Agent):
...
@@ -1571,6 +1678,13 @@ class OmniAgent(Agent):
...
@@ -1586,10 +1700,12 @@ class OmniAgent(Agent):
     ) -> None:
         return None
...
+        domain_probe_scores: Optional[Dict[str, DomainProbeScore]] = None,
         ...
         if not session.auto_glossary_enabled:
             return
@@ -1620,6 +1736,7 @@ class OmniAgent(Agent):
                 now,
...
+                domain_probe_scores=domain_probe_scores or {},
             ...
             decision = router.observe(
@@ -2063,6 +2180,7 @@ class OmniAgent(Agent):
...
+from framework.agents.plugins.retrieval import MockRetrieval
 from framework.agents.term_memory.slice_registry import (
     ...
     rank_references,
@@ -34,6 +37,7 @@ class AutoWorkingFixedTop10Tests(unittest.TestCase):
...
@@ -100,6 +104,92 @@ class AutoWorkingFixedTop10Tests(unittest.TestCase):
