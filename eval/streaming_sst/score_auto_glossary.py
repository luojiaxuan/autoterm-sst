...
def main() -> None:
        ...
        rows.append(
            {
                ...
                "fixed_prompt_refs/chunk": row.get("prompt_refs_per_chunk", ""),
                "candidate_pool/chunk": row.get("candidate_pool_per_chunk", ""),
                "fixed_shortfall_chunks": row.get("prompt_shortfall_chunks", ""),
    ...
    cols = [
        ...
        "masked_terms_bleu",
        "refs/chunk",
        "fixed_prompt_refs/chunk",
        "candidate_pool/chunk",
        "fixed_shortfall_chunks",
        "rescue_chunks",
        "fixed_prompt_k",
        "prompt_gold@10",
        "retr_precision@10",
