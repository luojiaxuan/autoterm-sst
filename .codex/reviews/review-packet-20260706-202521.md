...
@@ -768,6 +790,123 @@ class OmniAgent(Agent):
...
+
     def _rescue_retrieval_slice(self, session: "OmniSession") -> Optional[RetrievalSlice]:
         if not self.config.autoterm_enable_open_rescue:
             return None
@@ -1100,6 +1239,7 @@ class OmniAgent(Agent):
...
@@ -1411,9 +1551,14 @@ class OmniAgent(Agent):
...
@@ -1571,6 +1716,14 @@ class OmniAgent(Agent):
...
@@ -1586,10 +1739,12 @@ class OmniAgent(Agent):
     ) -> None:
         return None
...
+        domain_probe_scores: Optional[Dict[str, DomainProbeScore]] = None,
         ...
         if not session.auto_glossary_enabled:
             return
@@ -1620,6 +1775,7 @@ class OmniAgent(Agent):
                 now,
...
+                domain_probe_scores=domain_probe_scores or {},
             ...
             decision = router.observe(
@@ -2063,6 +2219,7 @@ class OmniAgent(Agent):
...
@@ -100,6 +106,167 @@ class AutoWorkingFixedTop10Tests(unittest.TestCase):
