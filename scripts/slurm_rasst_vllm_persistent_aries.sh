...
export RASST_RAG_AUT_BATCH_MODE="${RASST_RAG_AUT_BATCH_MODE:-packed}"
export RASST_RAG_AUT_BATCH_ISOLATE="${RASST_RAG_AUT_BATCH_ISOLATE:-1}"
...
echo "[INFO] RASST_RAG_AUT_BATCH_MODE=${RASST_RAG_AUT_BATCH_MODE}"
echo "[INFO] RASST_RAG_AUT_BATCH_ISOLATE=${RASST_RAG_AUT_BATCH_ISOLATE}"
