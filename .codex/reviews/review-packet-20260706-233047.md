...
```text
a5ed4ff (HEAD -> framework, origin/framework) Add E2E generated-target glossary routing
...
```text
 README.md                                       |  21 +++--
 configs/autoterm_slices.yaml                    |   7 +-
 docs/adaptive_working_glossary.md               | 119 +++++++++++++-----------
 docs/adaptive_working_glossary_eval.md          |   7 +-
 docs/ai_glossary_sweep.md                       |  10 +-
 docs/auto_glossary_routing_probe_20260707.md    |  28 +++---
 framework/agents/omni.py                        |  44 ++++++---
 framework/agents/term_memory/domain_taxonomy.py |  12 +++
 framework/agents/term_memory/topic_router.py    |  14 +--
 test_auto_working_fixed_top10.py                |  65 +++++++++++--
 test_hybrid_window_topic_router.py              |  31 +++++-
 11 files changed, 245 insertions(+), 113 deletions(-)
