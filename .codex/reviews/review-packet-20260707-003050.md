...
```text
1e82762 (HEAD -> framework, origin/framework) Document mixed-domain glossary switch results
...
```text
 docs/adaptive_working_glossary_eval.md         |  10 +
 docs/auto_glossary_mixed_switch_20260707.md    |  94 ++++
 eval/streaming_sst/eval_mixed_domain_switch.py | 574 +++++++++++++++++++++++++
 framework/agents/term_memory/topic_router.py   |   8 +-
 test_hybrid_window_topic_router.py             |  23 +
 test_mixed_domain_switch_eval.py               |  88 ++++
...
Current file excerpt/full content, possibly truncated:
```text
Verification run before Claude review:
...
```text
$ cd /home/jiaxuanluo/rasst-demo && python3 -m unittest test_mixed_domain_switch_eval test_hybrid_window_topic_router test_auto_glossary_switch_eval
.................
----------------------------------------------------------------------
...
Benchmark outputs on Taurus from git ref b96b982:
...
--- a/framework/agents/ter

...[truncated .codex/reviews/review-packet-20260706-204908.md to 30000 chars]...
