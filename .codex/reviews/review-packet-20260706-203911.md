...
@@ -768,6 +790,148 @@ class OmniAgent(Agent):
...
+
     def _rescue_retrieval_slice(self, session: "OmniSession") -> Optional[RetrievalSlice]:
         if not self.config.autoterm_enable_open_rescue:
             return None
@@ -1100,6 +1264,7 @@ class OmniAgent(Agent):
...
@@ -1411,9 +1576,15 @@ class OmniAgent(Agent):
...
@@ -1571,6 +1742,14 @@ class OmniAgent(Agent):
...
@@ -1586,10 +1765,12 @@ class OmniAgent(Agent):
     ) -> None:
         return None
...
+        domain_probe_scores: Optional[Dict[str, DomainProbeScore]] = None,
         ...
         if not session.auto_glossary_enabled:
             return
@@ -1620,6 +1801,7 @@ class OmniAgent(Agent):
                 now,
...
+                domain_probe_scores=domain_probe_scores or {},
             ...
             decision = router.observe(
@@ -2063,6 +2245,7 @@ class OmniAgent(Agent):
...
index 5787d7d..19eca40 100644
--- a/framework/agents/plugins/retrieval.py
+++ b/framework/agents/plugins/retrieval.py
@@ -446,46 +446,165 @@ class MaxSimRetrievalPlugin(RetrievalPlugin):
     ) -> Dict[str, DomainProbeScore]:
...
@@ -33,6 +36,58 @@ class MaxSimRetrievalPluginTests(unittest.IsolatedAsyncioTestCase):
