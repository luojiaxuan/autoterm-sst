...
#SBATCH --dependency=afterok:4598573
##SBATCH --array=1-7
...
stage1_ckpt_dir="/compute/babel-5-23/siqiouya/runs/iwslt25/en-${lang_code}/stage1_M=12_ls-cv-vp_norm0_qwen_rope/last.ckpt/"
save_dir=/compute/babel-5-23/siqiouya/runs/iwslt25/en-${lang_code}

source_lang="English"
target_lang=${lang} # e.g. German
name="stage2_M=12_ls-cv-vp_norm0_qwen_rope"
