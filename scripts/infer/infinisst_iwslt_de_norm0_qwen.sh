...
state_dict_path="/compute/babel-5-23/siqiouya/runs/iwslt25/en-de/stage1_M=12_ls-cv-vp_norm0_qwen/last.ckpt/pytorch_model.bin"
lora_path="/compute/babel-5-23/siqiouya/runs/iwslt25/en-de/stage2_M=12_ls-cv-vp_norm0_qwen/last.ckpt/pytorch_model.bin"
lora_rank=32
save_dir="/compute/babel-5-23/siqiouya/runs/iwslt25/en-de/stage2_M=12_ls-cv-vp_norm0_qwen/last.ckpt/"
