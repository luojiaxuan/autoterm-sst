...
export RASST_SGLANG_COALESCE_SEC="${RASST_SGLANG_COALESCE_SEC:-0.06}"
export RASST_SGLANG_MAX_INFLIGHT_BATCHES="${RASST_SGLANG_MAX_INFLIGHT_BATCHES:-2}"
...
docker run --rm \
  ...
  -e RASST_BATCH_TIMEOUT \
  -e RASST_SGLANG_COALESCE_SEC \
  -e RASST_SGLANG_MAX_INFLIGHT_BATCHES \
